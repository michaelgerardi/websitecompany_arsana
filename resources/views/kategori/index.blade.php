...
<head>
    ...
    <title>Admin Arsana Website</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Arsana Admin</sup></div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="cards.html">Data Konten</a>
                        <a class="collapse-item" href="cards.html">Data Peserta</a>
                        <a class="collapse-item" href="cards.html">Data Pengajar</a>
                        <a class="collapse-item" href="cards.html">Data Slider</a>
                        <a class="collapse-item" href="/Imageportofolio">Data Portofolio</a>
                        <a class="collapse-item" href="cards.html">Data Layanan</a>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Begin Page Content -->
                  <h1 style="margin-left: 10px">Data Tabel Kategori</h1>
                  <br>
