  ...
  <div class="container">
        ...
        <div class="cardcontainer">
            ...
            <div class="content">
                ...
                <p class="txt2">{{\Illuminate\Support\Str::limit($konten->keterangan, 150, $end='...')}} </p>
            </div>
            <div class="footer">
                <p><a class="waves-effect waves-light btn" href="/viewblog/{{$konten->id}}">Read More</a></a></p>
...
<div class="container-fluid col-md-4">
  ...
  <div class="container">
        ...
        <div class="cardcontainer">
            ...
            <div class="footer">
                <p><a class="waves-effect waves-light btn" href="/viewlay/{{$layanan->id}}">Read More</a></a></p>
                <!-- <p class="txt3"><i class="far fa-clock"></i>10 Minutes Ago <span class="comments"><i class="fas fa-comments"></i>45 Comments</span></p> -->
            </div>
        </div>
    </div>
